...
- graph view now supports group filters, relation-type filters, local neighborhood scope, focused node exploration, evidence jumps, and draggable pinned nodes
...
3. improve dense graph readability with collapse, expansion, and stronger local clustering
